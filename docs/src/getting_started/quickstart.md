...
2. **Simulator Tab**:
   - **Model Selection**: Choose your stack (e.g., `ZSW_nominal`, `EH_nominal`, or `custom`).
...
|-----------|---------|---------|
| `type_fuel_cell` | `:ZSW_nominal`, `:ZSW_Pa_1_61_Pc_1_41`, `:EH_nominal`, etc. | Select fuel cell model |
