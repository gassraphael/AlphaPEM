...
A detailed presentation of this program was published in the peer-reviewed journal SoftwareX as (see section [Related publications](#related-publications)). Furthermore, comprehensive [documentation](https://www.to-do.fr/) in Numpy style for the software functions is available.  (**to do!!**)
