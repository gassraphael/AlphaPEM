...
"""
This file is designated for executing the undetermined parameters' calibration, starting from a local optimum.
"""
...
epsilon_gdl_min, epsilon_gdl_max = 0.6, 0.8  # It is the anode/cathode GDL porosity, without units.
epsilon_mc_min, epsilon_mc_max = 0.3, 0.4  # It is the volume fraction of ionomer in the CL.
tau_min, tau_max = 1.0, 1.5  # It is the pore structure coefficient, without units.
epsilon_c_min, epsilon_c_max = 0.25, 0.3  # It is the compression ratio of the GDL.
#       Constants based on the interaction between water and the structure
e_min, e_max = 4, 5  # It is the capillary exponent, and should be an int number.
#       Voltage polarization
Re_min, Re_max = 5e-7, 2e-6  # ohm.m². It is the electron conduction resistance of the circuit.
i0_c_ref_min, i0_c_ref_max = 1, 10  # A.m-2.It is the reference exchange current density at the cathode.
kappa_co_min, kappa_co_max = 5, 30  # A.m-2. It is the crossover correction coefficient.
kappa_c_min, kappa_c_max = 0.8, 2  # It is the overpotential correction exponent.
...
#       Bounds gathering
varbound = np.array([[epsilon_gdl_min, epsilon_gdl_max], [epsilon_mc_min, epsilon_mc_max], [tau_min, tau_max],
                     [epsilon_c_min, epsilon_c_max], [e_min, e_max], [Re_min, Re_max], [i0_c_ref_min, i0_c_ref_max],
                     [kappa_co_min, kappa_co_max], [kappa_c_min, kappa_c_max], [a_slim_min, a_slim_max],
...
# Local optimum
local_optimum = np.array([[0.7011156494971454, 0.3949198274842546, 1.015639135686993, 0.27052745219052654, 5,
                           5.694464714060734e-07, 2.787917581303015, 29.793535549174077, 1.6136446641573106,
                           0.0555312850726664, 0.10514269908118055, 0.6365424991141914]] * 96)

# Undetermined parameter which is not considered yet (require the use of EIS curves to be calibrated)
C_scl = 2e7  # F.m-3. It is the volumetric double layer capacitance.
...
# ___________________________________Characteristic points of the polarization curve____________________________________
...
def pola_points(x):
    ...
    Simulator1 = AlphaPEM(current_density, T_des_1, Pa_des_1, Pc_des_1, Sa_1, Sc_1, Phi_a_des_1, Phi_c_des_1,
                          t_step, i_step, i_pola_1, delta_pola, i_EIS, ratio_EIS, t_EIS, f_EIS, Aact, Hgdl, Hmem, Hcl,
                          Hgc, Wgc, Lgc, epsilon_gdl, tau, epsilon_mc, epsilon_c, e, Re, i0_c_ref, kappa_co, kappa_c,
                          a_slim, b_slim, a_switch, C_scl, max_step, n_gdl, t_purge, type_fuel_cell_1, type_current,
                          type_auxiliary, type_control, type_purge, type_display, type_plot)
    Simulator2 = AlphaPEM(current_density, T_des_2, Pa_des_2, Pc_des_2, Sa_2, Sc_2, Phi_a_des_2, Phi_c_des_2,
                          t_step, i_step, i_pola_2, delta_pola, i_EIS, ratio_EIS, t_EIS, f_EIS, Aact, Hgdl, Hmem, Hcl,
                          Hgc, Wgc, Lgc, epsilon_gdl, tau, epsilon_mc, epsilon_c, e, Re, i0_c_ref, kappa_co, kappa_c,
                          a_slim, b_slim, a_switch, C_scl, max_step, n_gdl, t_purge, type_fuel_cell_2, type_current,
                          type_auxiliary, type_control, type_purge, type_display, type_plot)
