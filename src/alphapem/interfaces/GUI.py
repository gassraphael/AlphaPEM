...
from GUI_modules import (display_parameter_labels,  display_parameters_value,
...
def main_frame(root, canvas):
    ...
    choice_undetermined_parameters = \
        {'GDL thickness - Hgdl (µm)': {'value': tk.DoubleVar(accessible_parameters_frame), 'label_row': 0, 'label_column': 1},
         ...
         'Compression ratio - ε_c': {'value': tk.DoubleVar(undetermined_parameters_frame), 'label_row': 2, 'label_column': 3},
         'Capillary exponent - e': {'value': tk.IntVar(undetermined_parameters_frame), 'label_row': 2, 'label_column': 5},
         'Ratio of liq. and vap. water sorption\nrates in the mem. - K_l_ads': {'value': tk.IntVar(undetermined_parameters_frame), 'label_row': 3, 'label_column': 1},
         'Interfacial res. coef. of\nO2 ads. on Pt - K_O2_ad_Pt': {'value': tk.IntVar(undetermined_parameters_frame), 'label_row': 3, 'label_column': 3},
         'Electron conduction\nresistance - Re (Ω.mm²)': {'value': tk.DoubleVar(undetermined_parameters_frame), 'label_row': 3, 'label_column': 5},
         'Reference exchange current\ndensity - i0_c_ref (A/m²)': {'value': tk.DoubleVar(undetermined_parameters_frame), 'label_row': 4, 'label_column': 1},
         'Crossover correction coefficient\n- κ_co (mol/(m.s.Pa))': {'value': tk.DoubleVar(undetermined_parameters_frame), 'label_row': 4, 'label_column': 3},
         'Overpotential correction\nexponent - κ_c': {'value': tk.DoubleVar(undetermined_parameters_frame), 'label_row': 4, 'label_column': 5},
         'Volumetric space-charge layer\ncapacitance - C_scl (F/cm³)': {'value': tk.DoubleVar(undetermined_parameters_frame), 'label_row': 5, 'label_column': 1}}
