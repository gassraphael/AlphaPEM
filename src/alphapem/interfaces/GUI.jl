...
# Import Python modules for tkinter, ttkthemes, and matplotlib
const tk = PyCall.pyimport("tkinter")
const ThemedTk = PyCall.pyimport("ttkthemes").ThemedTk
const ttk = PyCall.pyimport("tkinter.ttk")
const plt = PyCall.pyimport("matplotlib.pyplot")

# Import Julia modules
include("GUI_modules.jl")

# Importing constants' value and functions
using .AlphaPEM
using .AlphaPEM.Config.Parameters: calculate_current_density_parameters
using .AlphaPEM.Config.CurrentDensities: step_current, polarization_current, EIS_current
...
function create_application()
    ...
    root.geometry("$(frame.winfo_width())x$(frame.winfo_height())")
...
"""
    main_frame(root::Any, canvas::Any)
...
"""
function main_frame(root, canvas)
    ...
    choice_operating_conditions = Dict(
        "Temperature - Tfc (°C)" => Dict("value" => tk.DoubleVar(operating_conditions_frame), "label_row" => 2, "label_column" => 1),
        "Anode pressure - Pa (bar)" => Dict("value" => tk.DoubleVar(operating_conditions_frame), "label_row" => 2, "label_column" => 3),
        "Cathode pressure - Pc (bar)" => Dict("value" => tk.DoubleVar(operating_conditions_frame), "label_row" => 2, "label_column" => 5),
        "Anode stoichiometry - Sa" => Dict("value" => tk.DoubleVar(operating_conditions_frame), "label_row" => 3, "label_column" => 1),
        "Cathode stoichiometry - Sc" => Dict("value" => tk.DoubleVar(operating_conditions_frame), "label_row" => 3, "label_column" => 3),
        "Anode humidity - Φa" => Dict("value" => tk.DoubleVar(operating_conditions_frame), "label_row" => 4, "label_column" => 1),
        "Cathode humidity - Φc" => Dict("value" => tk.DoubleVar(operating_conditions_frame), "label_row" => 4, "label_column" => 3),
        "Anode inlet H2 ratio - y_H2_in\n(flow-through anode only)" => Dict("value" => tk.DoubleVar(operating_conditions_frame), "label_row" => 4, "label_column" => 5)
    )

    choice_accessible_parameters = Dict(
        "Active area - Aact (cm²)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 1, "label_column" => 1),
        "Number of cells - nb_cell" => Dict("value" => tk.IntVar(accessible_parameters_frame), "label_row" => 1, "label_column" => 3),
        "Anode gas channel\nthickness - Hagc (µm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 2, "label_column" => 1),
        "Cathode gas channel\nthickness - Hcgc (µm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 2, "label_column" => 3),
        "Anode gas channel\nwidth - Wagc (µm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 2, "label_column" => 5),
        "Cathode gas channel\nwidth - Wcgc (µm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 3, "label_column" => 5),
        "Gas channel length - Lgc (mm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 3, "label_column" => 1),
        "Number of channels inside the\ngas channel - nb_channel_in_gc" => Dict("value" => tk.IntVar(accessible_parameters_frame), "label_row" => 3, "label_column" => 3),
        "Distributor length - Ldist (mm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 4, "label_column" => 1),
        "Manifold length - Lm (mm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 4, "label_column" => 3),
        "Exhaust anode manifold throttle\narea - A_T_a (cm²)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 5, "label_column" => 1),
        "Exhaust cathode manifold throttle\narea - A_T_c (cm²)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 5, "label_column" => 3),
        "Supply anode manifold\nvolume - Vasm (cm³)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 5, "label_column" => 5),
        "Supply cathode manifold\nvolume - Vcsm (cm³)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 6, "label_column" => 1),
        "Exhaust anode manifold\nvolume - Vaem (cm³)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 6, "label_column" => 3),
        "Exhaust cathode manifold\nvolume - Vcem (cm³)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 6, "label_column" => 5),
        "Anode endplate volume - V_endplate_c (cm³)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 7, "label_column" => 1),
        "Cathode endplate volume - V_endplate_c (cm³)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 7, "label_column" => 3)
    )

    choice_undetermined_parameters = Dict(
        "GDL thickness - Hgdl (µm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 0, "label_column" => 1),
        "MPL thickness - Hmpl (µm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 0, "label_column" => 3),
        "ACL thickness - Hacl (µm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 0, "label_column" => 5),
        "CCL thickness - Hccl (µm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 1, "label_column" => 1),
        "Membrane thickness - Hmem (µm)" => Dict("value" => tk.DoubleVar(accessible_parameters_frame), "label_row" => 1, "label_column" => 3),
        "GDL porosity - ε_gdl" => Dict("value" => tk.DoubleVar(undetermined_parameters_frame), "label_row" => 1, "label_column" => 5),
        "MPL porosity - ε_mpl" => Dict("value" => tk.DoubleVar(undetermined_parameters_frame), "label_row" => 2, "label_column" => 1),
        "Compression ratio - ε_c" => Dict("value" => tk.DoubleVar(undetermined_parameters_frame), "label_row" => 2, "label_column" => 3),
        "Capillary exponent - e" => Dict("value" => tk.IntVar(undetermined_parameters_frame), "label_row" => 2, "label_column" => 5),
        "Ratio of liq. and vap. water sorption\nrates in the mem. - K_l_ads" => Dict("value" => tk.IntVar(undetermined_parameters_frame), "label_row" => 3, "label_column" => 1),
        "Interfacial res. coef. of\nO2 ads. on Pt - K_O2_ad_Pt" => Dict("value" => tk.IntVar(undetermined_parameters_frame), "label_row" => 3, "label_column" => 3),
        "Electron conduction\nresistance - Re (Ω.mm²)" => Dict("value" => tk.DoubleVar(undetermined_parameters_frame), "label_row" => 3, "label_column" => 5),
        "Reference exchange current\ndensity - i0_c_ref (A/m²)" => Dict("value" => tk.DoubleVar(undetermined_parameters_frame), "label_row" => 4, "label_column" => 1),
        "Crossover correction coefficient\n- κ_co (mol/(m.s.Pa))" => Dict("value" => tk.DoubleVar(undetermined_parameters_frame), "label_row" => 4, "label_column" => 3),
        "Overpotential correction\nexponent - κ_c" => Dict("value" => tk.DoubleVar(undetermined_parameters_frame), "label_row" => 4, "label_column" => 5),
        "Volumetric space-charge layer\ncapacitance - C_scl (F/cm³)" => Dict("value" => tk.DoubleVar(undetermined_parameters_frame), "label_row" => 5, "label_column" => 1)
    )

    choice_current_density_parameters = Dict(
        "Stabilisation time\n- Δt_ini_step (min)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, step_current_parameters[:delta_t_ini_step]/60), "label_row" => 0, "label_column" => 3),
        "Loading time\n- Δt_load_step (s)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, step_current_parameters[:delta_t_load_step]), "label_row" => 0, "label_column" => 5),
        "Breaking time\n- Δt_break_step (min)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, step_current_parameters[:delta_t_break_step]/60), "label_row" => 1, "label_column" => 3),
        "Current density step\n- i_step (A/cm²)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, step_current_parameters[:i_step]/1e4), "label_row" => 1, "label_column" => 5),
        "Stabilisation time\n- Δt_ini_pola (min)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, pola_current_parameters[:delta_t_ini_pola]/60), "label_row" => 2, "label_column" => 3),
        "Loading time\n- Δt_load_pola (s)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, pola_current_parameters[:delta_t_load_pola]), "label_row" => 2, "label_column" => 5),
        "Breaking time\n- Δt_break_pola (min)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, pola_current_parameters[:delta_t_break_pola]/60), "label_row" => 3, "label_column" => 3),
        "Current density step\n- Δi_pola (A/cm²)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, pola_current_parameters[:delta_i_pola]/1e4), "label_row" => 3, "label_column" => 5),
        "Maximum current density\n- i_max_pola (A/cm²)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, 1.5), "label_row" => 4, "label_column" => 3),
        "Static current\n- i_EIS (A/cm²)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, i_EIS), "label_row" => 5, "label_column" => 3),
        "Current ratio\n- ratio_EIS (%)" => Dict("value" => tk.DoubleVar(current_density_parameters_frame, ratio_EIS), "label_row" => 5, "label_column" => 5),
        "Number of points\ncalculated - nb_points_EIS" => Dict("value" => tk.IntVar(current_density_parameters_frame, nb_points_EIS), "label_row" => 6, "label_column" => 3),
        "Power of the\ninitial frequency\n- f_power_min_EIS" => Dict("value" => tk.IntVar(current_density_parameters_frame, f_power_min_EIS), "label_row" => 6, "label_column" => 5),
        "Power of the\nfinal frequency\n- f_power_max_EIS" => Dict("value" => tk.IntVar(current_density_parameters_frame, f_power_max_EIS), "label_row" => 7, "label_column" => 3),
        "Number of frequencies\ntested - nb_f_EIS" => Dict("value" => tk.IntVar(current_density_parameters_frame, nb_f_EIS), "label_row" => 7, "label_column" => 5)
    )

    choice_computing_parameters = Dict(
        "Time for dynamic\ndisplay - Δt_dyn_step (s)" => Dict("value" => tk.DoubleVar(computing_parameters_frame, 300), "label_row" => 0, "label_column" => 1),
        "Purge time - t_purge (s)" => Dict("value" => tk.DoubleVar(computing_parameters_frame, 0.6), "label_row" => 0, "label_column" => 3),
        "Time between two purges\n- Δt_purge (s)" => Dict("value" => tk.DoubleVar(computing_parameters_frame, 15), "label_row" => 0, "label_column" => 5),
        "Number of GC nodes - nb_gc" => Dict("value" => tk.IntVar(computing_parameters_frame, 5), "label_row" => 1, "label_column" => 1),
        "Number of GDL nodes - nb_gdl" => Dict("value" => tk.IntVar(computing_parameters_frame, 5), "label_row" => 1, "label_column" => 3),
        "Number of MPL nodes - nb_mpl" => Dict("value" => tk.IntVar(computing_parameters_frame, 5), "label_row" => 1, "label_column" => 5),
        "Solver relative tolerance - rtol" => Dict("value" => tk.DoubleVar(computing_parameters_frame, 1e-5), "label_row" => 2, "label_column" => 1),
        "Solver absolute tolerance - atol" => Dict("value" => tk.DoubleVar(computing_parameters_frame, 1e-8), "label_row" => 2, "label_column" => 3)
    )

    choice_buttons = Dict(
        "type_fuel_cell" => Dict("value" => tk.StringVar(operating_conditions_frame, "Enter your specifications"), "label_row" => 0),
        "type_auxiliary" => Dict("value" => tk.IntVar(model_possibilities_frame, 2), "label_row" => 1),
        "voltage_zone" => Dict("value" => tk.IntVar(model_possibilities_frame, 0), "label_row" => 2),
        "type_purge" => Dict("value" => tk.IntVar(model_possibilities_frame, 0), "label_row" => 3),
        "type_display" => Dict("value" => tk.IntVar(model_possibilities_frame, 1), "label_row" => 4),
        "type_plot" => Dict("value" => tk.IntVar(model_possibilities_frame, 0), "label_row" => 5)
    )
    ...
    ttk.Button(root, text="Undetermined physical parameters", style="Big.TButton",
               command=() -> toggle_info(undetermined_parameters_frame, show_info_undetermined_parameters, canvas)).grid(row=4, column=0, padx=5, pady=5)
    ttk.Button(root, text="Current density parameters", style="Big.TButton",
               command=() -> toggle_info(current_density_parameters_frame, show_info_current_density_parameters, canvas)).grid(row=6, column=0, padx=5, pady=5)
    ttk.Button(root, text="Computing parameters", style="Big.TButton",
               command=() -> toggle_info(computing_parameters_frame, show_info_computing_parameters, canvas)).grid(row=8, column=0, padx=5, pady=5)
    ...
    ttk.Label(operating_conditions_frame, text="Fuel cell:", font=("cmr10", 12, "bold")).grid(row=0, column=0, columnspan=2)
    ttk.OptionMenu(operating_conditions_frame, choice_buttons["type_fuel_cell"]["value"],
                   ...
                   command=value -> changeValue(operating_conditions_frame, accessible_parameters_frame,
                                                 undetermined_parameters_frame, current_density_parameters_frame,
                                                 computing_parameters_frame, choice_operating_conditions,
                                                 choice_accessible_parameters, choice_undetermined_parameters,
                                                 choice_current_density_parameters, choice_computing_parameters,
                                                 choice_buttons)).grid(row=0, column=2, columnspan=2)

    # Display the action buttons to select the type of current density to be applied.
    ttk.Label(model_possibilities_frame, text="Current density:", font=("cmr10", 12, "bold")).grid(row=6, column=0, columnspan=2, sticky="w")
    current_button = Dict("Step curve" => 0, "Pola curve" => 1, "EIS curve" => 2)
    #       Button to generate the step curve
    ttk.Button(model_possibilities_frame, text="Step curve", style="Blue.TButton",
               command=() -> control_current_button(choice_operating_conditions, choice_accessible_parameters,
                                                    choice_undetermined_parameters, choice_current_density_parameters,
                                                    choice_computing_parameters, choice_buttons,
                                                    current_button["Step curve"])).grid(row=7, column=2, padx=10, pady=20)
    #       Button to generate the Pola curve
    ttk.Button(model_possibilities_frame, text="Pola curve", style="Green.TButton",
               command=() -> control_current_button(choice_operating_conditions, choice_accessible_parameters,
                                                    choice_undetermined_parameters, choice_current_density_parameters,
                                                    choice_computing_parameters, choice_buttons,
                                                    current_button["Pola curve"])).grid(row=7, column=3, padx=10, pady=20)
    #       Button to generate the EIS curve
    ttk.Button(model_possibilities_frame, text="EIS curve", style="Red.TButton",
               command=() -> control_current_button(choice_operating_conditions, choice_accessible_parameters,
                                                    choice_undetermined_parameters, choice_current_density_parameters,
                                                    choice_computing_parameters, choice_buttons,
                                                    current_button["EIS curve"])).grid(row=7, column=4, padx=10, pady=20)
    #       About button
    ttk.Button(model_possibilities_frame, text="About", style="Black.TButton", command=() -> about()).grid(row=7, column=5, ipadx=12)
...
"""
    toggle_info(frame::Any, show_info::Any, canvas::Any)
...
"""
function toggle_info(frame, show_info, canvas)
    if show_info.get()
...
"""
function control_current_button(choice_operating_conditions, choice_accessible_parameters, choice_undetermined_parameters,
...
current_button : int
    A dictionary representing the clicked button.
"""
function show_current_button(choice_operating_conditions, choice_accessible_parameters, choice_undetermined_parameters,
                             choice_current_density_parameters, choice_computing_parameters, choice_buttons, current_button)
    ...
    (T_des, Pa_des, Pc_des, Sa, Sc, Phi_a_des, Phi_c_des, y_H2_in, Aact, nb_cell, Hgdl, Hmpl, Hacl, Hccl, Hmem, Hagc,
     ...
     V_endplate_c, epsilon_gdl, epsilon_mpl, epsilon_c, e, K_l_ads, K_O2_ad_Pt, Re, i0_c_ref, kappa_co, kappa_c, C_scl,
     step_current_parameters, pola_current_parameters, pola_current_for_cali_parameters, i_EIS, ratio_EIS, f_EIS, t_EIS,
    ...
    undetermined_physical_parameters = Dict(
        "Hgdl" => Hgdl, "Hmpl" => Hmpl, "Hmem" => Hmem, "Hacl" => Hacl, "Hccl" => Hccl,
    ...
    model_parameters = Dict(
        "nb_gc" => nb_gc, "nb_gdl" => nb_gdl, "nb_mpl" => nb_mpl, "t_purge" => t_purge, "rtol" => rtol,
        "atol" => atol
    )
    ...
    if current_button == 0
        ...
        operating_inputs = Dict(
            "current_density" => current_density, "T_des" => T_des, "Pa_des" => Pa_des, "Pc_des" => Pc_des,
