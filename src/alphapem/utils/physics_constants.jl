...
const gamma_sorp_l::Float64 = 0.5 # s-1. Sorption rate of liquid water in the membrane [Ansys Fluent value from their User Guide].
...
const r_carb::Float64 = 40e-9  # m. It is the mean radius of the carbon particles.
