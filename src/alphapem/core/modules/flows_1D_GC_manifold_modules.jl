...
function flow_1D_GC_manifold_int_values(sv_1D_cell::Vector{<:Dict},
    ...
    k_purge = nothing
    Abp_a = get(sv_auxiliary, "Abp_a", nothing)
    Abp_c = get(sv_auxiliary, "Abp_c", nothing)
    ...
    for i in 1:nb_gc
        sv_i = sv_1D_cell[i]
        C_v_agc_i = sv_i["C_v_agc"]
        C_v_cgc_i = sv_i["C_v_cgc"]
        C_H2_agc_i = sv_i["C_H2_agc"]
        C_O2_cgc_i = sv_i["C_O2_cgc"]
        C_N2_agc_i = sv_i["C_N2_agc"]
        C_N2_cgc_i = sv_i["C_N2_cgc"]
        T_agc_i = sv_i["T_agc"]
        T_cgc_i = sv_i["T_cgc"]
