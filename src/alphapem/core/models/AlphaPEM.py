...
class AlphaPEM:
    ...
    def Display(self, ax1=None, ax2=None, ax3=None):
        ...
        if type_current == "step":
            if type_display == "multiple":
                ...
                self.Saving_instructions("results", subfolder_name, "step_current_Cv_1.pdf", figs[1])
                self.Saving_instructions("results", subfolder_name, "step_current_lambda_1.pdf", figs[2])
                self.Saving_instructions("results", subfolder_name, "step_current_s_1.pdf", figs[3])
                self.Saving_instructions("results", subfolder_name, "step_current_C_O2_1.pdf", figs[4])
                self.Saving_instructions("results", subfolder_name, "step_current_C_H2_1.pdf", figs[5])
                self.Saving_instructions("results", subfolder_name, "step_current_C_N2_1.pdf", figs[6])
                self.Saving_instructions("results", subfolder_name, "step_current_T_1.pdf", figs[7])
                self.Saving_instructions("results", subfolder_name, "step_current_Ucell_1.pdf", figs[8])
                self.Saving_instructions("results", subfolder_name, "step_current_P_1.pdf", figs[9])
                self.Saving_instructions("results", subfolder_name, "step_current_v_1.pdf", figs[10])
    ...
    def Saving_instructions(self, root_folder, subfolder_name, filename, fig):
        ...
        folder_path = project_root / root_folder / subfolder_name
        ...
        fig.savefig(str(file_path), dpi=900, transparent=False, bbox_inches='tight')