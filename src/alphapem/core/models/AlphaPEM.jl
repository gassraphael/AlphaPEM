...
using SciMLBase: DAEFunction, NoInit, successful_retcode
using Sundials: IDA
...
function simulate_model!(simu::AlphaPEM,
    ...
    has_solver_restart_state = initial_variable_values !== nothing && initial_derivative_values !== nothing
    ...
    simu.initial_variable_values = initial_variable_values === nothing ?
                                   _create_dae_initial_values!(simu, simu.initial_variable_values,
                                                               ...
                                                               n_vars_auxiliary) : initial_variable_values
    ...
    simu.initial_derivative_values = initial_derivative_values === nothing ?
                                     _build_consistent_initial_solver_derivatives(residual!, packed,
                                                                                  ...
                                                                                  differential_vars) : initial_derivative_values
    ...
    jacobian! = (J, dydt_IDA, y, p, gamma, t) -> _dae_jacobian_fd!(J, dydt_IDA, y, p, gamma, t, residual!,
                                                                   differential_vars, jac_cache)
     #           Build and solve the DAE problem with IDA (Sundials).
    dae_fun = DAEFunction(residual!; jac=jacobian!, jac_prototype=jac_prototype)
    prob = DAEProblem(dae_fun, simu.initial_derivative_values, initial_scaled_variable_values, simu.time_interval, packed;
