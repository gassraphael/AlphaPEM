...
function experimental_values(fc::EH31, type_fuel_cell::String, voltage_zone::String)
    if type_fuel_cell == "EH-31_1.5"  # at 1.5 bar
        if voltage_zone == "full"
            i_exp = [0.050, 0.068, 0.089, 0.110, 0.147, 0.185, 0.233, 0.293, 0.352, 0.395,
            ...
            U_exp = [0.900, 0.882, 0.865, 0.850, 0.834, 0.823, 0.811, 0.794, 0.781, 0.772,
    ...
    if type_fuel_cell == "EH-31_2.0"  # at 2.0 bar
        if voltage_zone == "full"
            i_exp = [0.050, 0.057, 0.079, 0.106, 0.135, 0.171, 0.206, 0.242, 0.302, 0.346,
            ...
            U_exp = [0.900, 0.889, 0.874, 0.860, 0.853, 0.845, 0.837, 0.830, 0.817, 0.808,
    ...
    if type_fuel_cell == "EH-31_2.25"  # at 2.25 bar
        if voltage_zone == "full"
            i_exp = [0.056, 0.095, 0.120, 0.138, 0.160, 0.183, 0.218, 0.248, 0.279, 0.315,
            ...
            U_exp = [0.894, 0.882, 0.873, 0.867, 0.861, 0.854, 0.847, 0.840, 0.834, 0.827,
    ...
    if type_fuel_cell == "EH-31_2.5"  # at 2.5 bar
        if voltage_zone == "full"
            i_exp = [0.057, 0.070, 0.082, 0.101, 0.127, 0.145, 0.168, 0.200, 0.234, 0.267,
            ...
            U_exp = [0.900, 0.892, 0.884, 0.875, 0.866, 0.861, 0.856, 0.850, 0.845, 0.840,
