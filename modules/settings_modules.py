...
def stored_physical_parameters(type_fuel_cell):
    ...
    # For BX fuel cell
        ...
        tau = 1.4  # It is the pore structure coefficient, without units.
        # Membrane
        Hmem = 1e-5  # m. It is the thickness of the membrane.
        # Gas diffusion layer
        Hgdl = 2e-4  # m. It is the thickness of the gas diffusion layer.
        epsilon_gdl = 0.65  # It is the anode/cathode GDL porosity.
        epsilon_c = 0.3  # It is the compression ratio of the GDL.
        # Gas channel.
        Hgc = 5e-4  # m. It is the thickness of the gas channel.
        ...
        e = 5.0  # It is the capillary exponent
        # Voltage polarization
        Re = 2.2e-6  # ohm.m². It is the electron conduction resistance of the circuit.
        i0_c_ref = 3  # A.m-2.It is the reference exchange current density at the cathode.
        kappa_co = 2.9  # mol.m-1.s-1.Pa-1. It is the crossover correction coefficient.
        kappa_c = 0.4  # It is the overpotential correction exponent.
