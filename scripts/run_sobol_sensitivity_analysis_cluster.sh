...
#################################################################################
# AlphaPEM - HPC Cluster Sobol Sensitivity Analysis Script
#################################################################################
#
# Description:
#   This PBS script launches the Sobol global sensitivity analysis of AlphaPEM on
#   an HPC (High Performance Computing) cluster. It configures the environment,
#   installs dependencies, copies the project to a temporary workspace, runs the
#   analysis, and copies results back.
#
# Usage:
#   qsub scripts/run_sobol_sensitivity_analysis_cluster.sh
#
# Note:
#   - Adapt PBS parameters according to your cluster (ncpus, mem, walltime)
#   - The example driver script re-launches Julia with the desired thread count
#     when PARALLEL=true, but passing --threads=$NCPUS below avoids that restart.
#   - Results are written to results/sobol_sensitivity by default (configured in
#     examples/run_sobol_sensitivity_analysis.jl).
#
# Author: Raphaël Gass
# License: GPLv3
#################################################################################
...
#PBS -o out_sobol_sensitivity
#PBS -e err_sobol_sensitivity

# Job name displayed in queue
#PBS -N AlphaPEM_sobol_sensitivity
...
echo "================================================================================"
echo "              AlphaPEM Sobol Sensitivity Analysis - Job Information"
echo "================================================================================"
...
# install modern Python and its dependencies.
...
# **Sobol Sensitivity Analysis Execution:**
echo "================================================================================"
echo "              Launching AlphaPEM Sobol Sensitivity Analysis"
echo "================================================================================"
echo "[INFO] Script: examples/run_sobol_sensitivity_analysis.jl"
...
julia --threads=$NCPUS --project examples/run_sobol_sensitivity_analysis.jl
